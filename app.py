...
def load_perfect_liudu_data():
    raw_cities = {
        "臺北市": [
            ...
            ("中山區", 13.68, 25.068, 121.533, "core", 210, 13, 0, 0, 2, 0, 0, 145, 11, 10, 2, 3, 1, 1, 2, 410, 115),
        ...
        "臺南市": [
            ...
            ("東區", 13.44, 22.984, 120.222, "core", 210, 0, 1, 0, 0, 0, 0, 84, 9, 9, 1, 2, 1, 0, 2, 280, 89),
            ...
            ("中西區", 6.26, 22.992, 120.199, "core", 140, 0, 0, 0, 0, 0, 0, 56, 6, 4, 2, 2, 0, 1, 2, 150, 55),
            ...
            ("七股區", 91.02, 23.140, 120.141, "rural", 48, 0, 0, 0, 0, 0, 0, 12, 8, 2, 0, 1, 0, 0, 0, 14, 4),
            ...
            ("仁德區", 50.77, 22.972, 120.252, "suburb", 112, 0, 2, 0, 2, 0, 0, 54, 8, 2, 2, 1, 0, 0, 1, 82, 28),
        ...
        "高雄市": [
            ("三民區", 19.78, 22.643, 120.328, "core", 340, 6, 1, 0, 1, 0, 0, 155, 15, 10, 4, 3, 1, 1, 4, 326, 89),
            ("苓雅區", 8.15, 22.621, 120.329, "core", 260, 11, 0, 0, 1, 0, 0, 112, 9, 12, 1, 2, 0, 2, 2, 245, 76),
            ("左營區", 19.38, 22.690, 120.301, "core", 220, 4, 1, 1, 1, 0, 0, 124, 9, 5, 0, 2, 1, 0, 2, 210, 68),
            ("鼓山區", 14.74, 22.639, 120.275, "core", 165, 12, 1, 0, 0, 0, 0, 98, 7, 4, 1, 2, 1, 1, 1, 135, 46),
            ("前鎮區", 19.12, 22.597, 120.322, "core", 230, 13, 0, 0, 2, 0, 0, 105, 11, 8, 0, 2, 0, 0, 3, 195, 61),
            ...
            ("岡山區", 47.94, 22.791, 120.295, "suburb", 112, 2, 1, 0, 1, 0, 0, 52, 9, 5, 0, 3, 0, 1, 1, 98, 32),
            ...
            ("大寮區", 71.04, 22.605, 120.395, "suburb", 142, 1, 1, 0, 1, 0, 0, 64, 11, 6, 1, 1, 0, 0, 1, 110, 34),
